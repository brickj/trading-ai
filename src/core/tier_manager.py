...
class TierManager:
    ...
    def upgrade_tier(self, user_id: str, new_tier: str) -> Dict[str, Any]:
        ...
        if new_tier not in self.tier_configs:
            raise ValueError(
                f"Invalid tier: {new_tier}. Valid tiers: {list(self.tier_configs.keys())}"
            )
    ...
    def check_feature_access(self, user_id: str, feature: str) -> bool:
        ...
        try:
            ...
            log_error(
                f"Error checking feature access for {user_id}, feature {feature}: {str(e)}"
            )
            return False
    ...
    def get_tier_stats(self, user_id: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "api_usage": api_usage,
                "features_count": len(
                    tier_info.get("features", {}).get("features", [])
                ),
