...
class BaseRepository:
    ...
    def execute_batch(self, queries: List[Tuple[str, List]], 
                     transaction: bool = True) -> List[Any]:
        """
        Execute multiple queries efficiently with optional transaction support
        ...
        try:
            ...
            log_exception("Batch query execution error", e)
            raise
    ...
    def get_paginated_results(self, base_query: str, params: List = None,
        ...
        # Get count if count_query provided
        total_count = None
        if count_query:
            count_result = self.execute_query(
                count_query, params, fetch_one=True
            )
            total_count = count_result[0] if count_result else 0
        
        # Get paginated data
        data = self.execute_query(
            paginated_query, paginated_params, fetch_all=True
        )
        ...
        return {
            ...
            "pagination": {
                ...
                "has_next": total_pages and page < total_pages if total_pages else None,
                "has_prev": page > 1
            }
        }
